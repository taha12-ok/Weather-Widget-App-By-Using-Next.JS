...
export default function WeatherWidget() {
  ...
  return (
    <div
    className="flex justify-center items-center h-screen bg-gradient-to-r from-blue-300 via-white to-gray-300"
    style={{
  ...
  >
    ...
    <Card className="w-full max-w-md mx-auto text-center bg-white bg-opacity-90 shadow-xl rounded-lg">
      {/* Card header with title and description */}
      <CardHeader>
        <CardTitle className="text-2xl font-bold text-blue-800">Weather Widget</CardTitle>
